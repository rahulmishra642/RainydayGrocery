...
public class DemoController {
    ...
    public ResponseEntity<String> welcomeEmployee() {
        return new ResponseEntity<>("Hi Employee, You can start your Work", HttpStatus.OK);
    }
    //@PreAuthorize("hasRole('ADMIN')")
    @GetMapping("/welcome/admin")
    public ResponseEntity<String> welcomeAdmin() {
        return new ResponseEntity<>("Hi ADMIN, You can control everything", HttpStatus.OK);
    }
    //@PreAuthorize("hasRole('EMPLOYEE') or hasRole('ADMIN')")
    @GetMapping("/welcome/employeeOrAdmin")
    public ResponseEntity<String> welcomeEmployeeOrAdmin() {
        return new ResponseEntity<>("API for Employee and ADMIN role", HttpStatus.OK);
    }
